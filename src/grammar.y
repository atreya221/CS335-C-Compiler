...
init_declarator
	...
	| declarator '=' {/* error_message("Invalid Initialisation of declaration",line_no,col_no); */} assignment_expression	 { /*$$ = $1*/ $$ = add_initializer_to_declarator( $1, $2, $4 ); }
	;
...
direct_declarator
	...
	|  direct_declarator '[' '-' CONSTANT ']'	         { error_message("Array dimension must be a positive integer", $4->line_no, $4->col_no ); $$=NULL; }
